...
ALTER TABLE IF EXISTS ONLY public.user_address DROP CONSTRAINT IF EXISTS fk12_user_address CASCADE;
ALTER TABLE IF EXISTS ONLY public.user_address DROP CONSTRAINT IF EXISTS fk13_user_address CASCADE;
